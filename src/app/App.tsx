...
const MobileLogin = lazy(() =>
  import("./components/mobile/AuthScreens").then((m) => ({
    default: m.MobileLogin,
  })),
);
const MobileSignUp = lazy(() =>
  import("./components/mobile/AuthScreens").then((m) => ({
    default: m.MobileSignUp,
  })),
);
const MobileDashboard = lazy(() =>
  import("./components/mobile/AppScreens").then((m) => ({
    default: m.MobileDashboard,
  })),
);
const MobileBoardingPass = lazy(() =>
  import("./components/mobile/AppScreens").then((m) => ({
    default: m.MobileBoardingPass,
  })),
);
const MobileStatus = lazy(() =>
  import("./components/mobile/AppScreens").then((m) => ({
    default: m.MobileStatus,
  })),
);
...
const AdminLogin = lazy(() =>
  import("./components/admin/AdminScreens").then((m) => ({
...
const KYCVerification = lazy(() =>
  import("./components/admin/AdminScreens").then((m) => ({
    default: m.KYCVerification,
  })),
);
const SupportTickets = lazy(() =>
  import("./components/admin/AdminScreens").then((m) => ({
    default: m.SupportTickets,
  })),
);
...
const BoardingManagement = lazy(
  () => import("./components/boarding/BoardingManagement"),
);
const SearchDiscovery = lazy(
  () => import("./components/boarding/SearchDiscovery"),
);
const BookingAgreement = lazy(
  () => import("./components/boarding/BookingAgreement"),
);
const PaymentRentalPage = lazy(
  () => import("./components/payment/PaymentRentalPage"),
);
const BoardingPlaceDetail = lazy(
  () => import("./components/payment/BoardingPlaceDetail"),
);
const StudentPayment = lazy(
  () => import("./components/payment/StudentPayment"),
);
const AdministrationMonitoring = lazy(
  () => import("./components/boarding/AdministrationMonitoring"),
);
const RoommateFinderPage = lazy(
  () => import("./components/RoommateFinderPage"),
);
const RoommateFinderEnhanced = lazy(
  () => import("./components/RoommateFinderEnhanced"),
);
...
const BookingManagementSystem = lazy(
  () => import("./components/booking/BookingManagementSystem"),
);
const StudentBookingDashboard = lazy(
  () => import("./components/booking/StudentBookingDashboard"),
);
const UserProfileDashboard = lazy(
  () => import("./components/UserProfileDashboard"),
);
...
const RoommateFinderGroupPage = lazy(
  () => import("./components/RoommateFinderGroupPage"),
);
    ...
    <BrowserRouter>
      ...
      >
        <Routes>
          ...
          <Route
            path="/payment-rental/:placeId"
            element={<BoardingPlaceDetail />}
          />
          <Route path="/owner-bookings" element={<OwnerApprovalPage />} />
          <Route
            path="/student-booking"
            element={<StudentBookingDashboard />}
          />
          <Route path="/student-payment" element={<StudentPayment />} />
          <Route
            path="/admin-monitoring"
            element={<AdministrationMonitoring />}
          />
          ...
          <Route
            path="/roommate-finder-enhanced"
            element={<RoommateFinderEnhanced />}
          />
          ...
          <Route
            path="/chatbot"
            element={<ChatbotSection standalone={true} />}
          />
          ...
          {/* Catch-all: Show 404 or redirect to home instead of signin */}
          <Route path="*" element={<LandingPage />} />
        </Routes>
      </Suspense>
    </BrowserRouter>
