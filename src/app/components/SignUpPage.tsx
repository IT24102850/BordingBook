  ...
  <div className="flex items-center justify-center h-full w-full">
    <div className="relative w-[90%] h-[80%] max-w-[420px] max-h-[520px] bg-gradient-to-br from-cyan-400 via-purple-400 to-indigo-400 rounded-3xl shadow-2xl flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-10 left-10 bg-white/80 backdrop-blur-xl rounded-xl shadow-lg px-5 py-3 flex flex-col items-center border border-cyan-200 z-10 min-w-[120px]">
        <UserCheck className="text-cyan-400 mb-1" size={22}/>
        <div className="text-cyan-700 font-bold text-sm">SLIIT Verified</div>
      </div>
        ...
        <div className="w-full max-w-md mx-auto flex flex-col gap-6 bg-gradient-to-br from-[#181f36]/90 via-[#232b47]/90 to-[#0b132b]/90 rounded-3xl shadow-2xl p-6 md:p-10 border border-cyan-300/30">
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              />
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-cyan-300" size={22} />
              <label htmlFor="confirmPassword" className="absolute left-12 top-1/2 -translate-y-1/2 text-cyan-200 bg-[#181f36] px-1 font-bold transition-all duration-300 pointer-events-none peer-focus:-translate-y-7 peer-focus:scale-90 peer-focus:text-cyan-200 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:text-base peer-placeholder-shown:text-cyan-400 drop-shadow z-10 peer-not-empty:-translate-y-7 peer-not-empty:scale-90 peer-not-empty:text-cyan-200">Confirm Password</label>
            </div>
